# 100 Days of Python Challenge - Week 2 Summary

## Overview
Week 2 of the 100 Days of Python challenge, building on fundamental concepts to explore advanced function concepts, data structures, and game development patterns.
...
- **Skills**: String manipulation, modulo operations, module imports, function parameters

### Day 9 - Secret Auction Program
- **Concept**: Dictionaries and error handling
- **Project**: Secret auction bidding platform with input validation
- **Skills**: Dictionary methods, try/except blocks, OS module, cross-platform compatibility, data structures

### Day 10 - Calculator
- **Concept**: Functions as first-class objects
- **Project**: Interactive calculator with continuous operations
- **Skills**: Function storage in dictionaries, function references, chaining calculations, design patterns

### Day 11 - Blackjack Game
- **Concept**: Functions with outputs and game state management
- **Project**: Command-line Blackjack (21) game
- **Skills**: Return values, list manipulation, conditional logic, loops, complex game rules
...
- **Skills**: Random number generation, `while` loops, function parameters and return values, conditional logic, user input validation
...
- **Skills**: Debugging techniques, loops and list operations, using helper modules, `random.randint`, practicing with debugger tools (breakpoints, Step Into/Step Over)
